...
public class SixNoteAmpSideAlternate extends SequentialCommandGroup {

  public SixNoteAmpSideAlternate(
      Superstructure superstructure, Swerve swerve, Shooter shooter, Intake intake) {
    setName("SIX_NOTE_AMP_SIDE_ALTERNATE");
    ...
    addCommands(
        ...
        new TrajectoryFollowerCommand(
                () -> Robot.sixNoteAmpSideCAlternate,
                swerve,
                false,
        ...
        new TrajectoryFollowerCommand(
                () -> Robot.sixNoteAmpSideDAlternate,
                swerve,
                false,
                () -> superstructure.hasPiece())
            .beforeStarting(
